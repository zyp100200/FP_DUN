...
from davit.drop import DropPath
from davit.helpers import to_2tuple
from davit.weight_init import trunc_normal_, lecun_normal_
...
class DaViT(nn.Module):
    ...
    def __init__(self, in_chans=1, num_classes=1000, depths=(1, 1, 3, 1), patch_size=4,
                 embed_dims=(16, 32, 64, 128), num_heads=(2, 4, 8, 16), window_size=7, mlp_ratio=4.,
        ...
        self.channel_change = nn.Conv1d(in_channels=embed_dims[-1],out_channels=in_chans,kernel_size=1)
    ...
    def forward(self, x):
        ...
        x = self.channel_change(x.permute(0,2,1).contiguous())
...
if __name__ == '__main__':
    ...
    summary(model, input_size=(5, 1, 96, 96))
